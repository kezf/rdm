...
public class DeptController extends BaseController {
     ...
     * 新增保存部门
     */
    @Log(title = "部门管理", businessAction = BusinessAction.INSERT)
     ...
     * 保存
     */
    @Log(title = "部门管理", businessAction = BusinessAction.UPDATE)
     ...
     * 删除
     */
    @Log(title = "部门管理", businessAction = BusinessAction.DELETE)
