...
import org.miser.system.domain.SysPost;
...
public class PostController extends BaseController {
    ...
    @Log(title = "岗位管理", businessAction = BusinessAction.EXPORT)
    ...
    @Log(title = "岗位管理", businessAction = BusinessAction.DELETE)
    @PostMapping("/remove")
    @ResponseBody
    ...
    @Log(title = "岗位管理", businessAction = BusinessAction.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "岗位管理", businessAction = BusinessAction.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
