...
public class ConfigController extends BaseController {
    ...
    @Log(title = "参数管理", businessAction = BusinessAction.EXPORT)
    ...
    @Log(title = "参数管理", businessAction = BusinessAction.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "参数管理", businessAction = BusinessAction.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "参数管理", businessAction = BusinessAction.DELETE)
    @PostMapping("/remove")
    @ResponseBody
