...
public class JobController extends BaseController {
    ...
    @Log(title = "定时任务", businessAction = BusinessAction.EXPORT)
    ...
    @Log(title = "定时任务", businessAction = BusinessAction.DELETE)
     ...
     * 任务调度状态修改
     */
    @Log(title = "定时任务", businessAction = BusinessAction.UPDATE)
     ...
     * 新增保存调度
     */
    @Log(title = "定时任务", businessAction = BusinessAction.INSERT)
