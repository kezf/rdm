...
public class RoleController extends BaseController {
    ...
    @Log(title = "角色管理", businessAction = BusinessAction.EXPORT)
    ...
    @Log(title = "角色管理", businessAction = BusinessAction.INSERT)
    @PostMapping("/add")
    ...
    @Log(title = "角色管理", businessAction = BusinessAction.UPDATE)
    @PostMapping("/edit")
    @Transactional(rollbackFor = Exception.class)
    @ResponseBody
    ...
    @Log(title = "角色管理", businessAction = BusinessAction.DELETE)
    @PostMapping("/remove")
    @ResponseBody
