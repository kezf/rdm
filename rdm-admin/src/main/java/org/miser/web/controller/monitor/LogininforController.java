...
public class LogininforController extends BaseController {
    ...
    @Log(title = "登陆日志", businessAction = BusinessAction.EXPORT)
    ...
    @Log(title = "登陆日志", businessAction = BusinessAction.DELETE)
    @PostMapping("/remove")
    @ResponseBody
    ...
    @RequiresPermissions("monitor:logininfor:remove")
    @Log(title = "登陆日志", businessAction = BusinessAction.CLEAN)
    @PostMapping("/clean")
    @ResponseBody
