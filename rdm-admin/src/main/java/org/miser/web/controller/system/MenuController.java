...
public class MenuController extends BaseController {
     ...
     * 删除菜单
     */
    @Log(title = "菜单管理", businessAction = BusinessAction.DELETE)
     ...
     * 新增保存菜单
     */
    @Log(title = "菜单管理", businessAction = BusinessAction.INSERT)
     ...
     * 修改保存菜单
     */
    @Log(title = "菜单管理", businessAction = BusinessAction.UPDATE)
