...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(1, 0, '', '升腾云支付', 0, '', '', '', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00');
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1, 1, 'admin', '超级管理员', '00', '', '', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2018-10-09 21:14:25', 'admin', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', '管理员');
...
-- 登录日志按钮
insert into sys_menu values('1042', '登录查询', '501', '1', '#',  'F', '0', 'monitor:logininfor:list',         '#', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
insert into sys_menu values('1043', '登录删除', '501', '2', '#',  'F', '0', 'monitor:logininfor:remove',       '#', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
insert into sys_menu values('1044', '日志导出', '501', '2', '#',  'F', '0', 'monitor:logininfor:export',       '#', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
-- 在线用户按钮
...
insert into sys_job values(1, 'demoTask', '系统默认（无参）', 'demoNoParams',  '',   '0/10 * * * * ?', '0', '1', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
insert into sys_job values(2, 'demoTask', '系统默认（有参）', 'demoParams',    'admin', '0/20 * * * * ?', '0', '1', 'admin', '2018-03-16 11-33-00', 'admin', '2018-03-16 11-33-00', '');
