...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='薪酬变动表';

-- ----------------------------
-- Table structure for rdm_product
-- ----------------------------
DROP TABLE IF EXISTS `rdm_product`;
CREATE TABLE `rdm_product` (
  `product_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '产品ID',
  `dept_id` int(11) DEFAULT '0' COMMENT '所属部门',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '产品名称',
  `leader` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '产品经理',
  `type` char(1) DEFAULT NULL COMMENT '产品类型',
  `svn_user` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'SVN用户名',
  `svn_password` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'SVN密码',
  `svn_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'SVN路径',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '产品状态',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `rdm_project` (
  ...
  `group_id` int(11) NOT NULL DEFAULT '0' COMMENT '所属组',
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '项目名称',
  `type` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '项目类型',
  `leader` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '项目经理',
  `seller` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '销售经理',
  `customers` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '客户',
  `svn_user` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'SVN用户名',
  `svn_password` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'SVN密码',
  `svn_path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'SVN路径',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '项目状态',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
-- ----------------------------
-- Table structure for rdm_project_group
-- ----------------------------
DROP TABLE IF EXISTS `rdm_project_group`;
CREATE TABLE `rdm_project_group` (
...
-- ----------------------------
-- Table structure for rdm_project_product
-- ----------------------------
DROP TABLE IF EXISTS `rdm_project_product`;
CREATE TABLE `rdm_project_product` (
  `project_id` int(11) NOT NULL COMMENT '项目ID',
  `product_id` int(11) NOT NULL COMMENT '产品ID',
  PRIMARY KEY (`project_id`,`product_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目和产品关联表';

-- ----------------------------
-- Table structure for rdm_test
-- ----------------------------
DROP TABLE IF EXISTS `rdm_test`;
CREATE TABLE `rdm_test` (
  `test_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '测试ID',
  `project_id` int(11) NOT NULL DEFAULT '0' COMMENT '项目ID',
  `environment` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '测试环境',
  `equipment` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '测试设备',
  `requirement` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '测试需求',
  `submit_time` datetime DEFAULT NULL COMMENT '计划提交时间',
  `complete_time` datetime DEFAULT NULL COMMENT '计划完成时间',
  `round` tinyint(4) DEFAULT NULL COMMENT '计划轮次',
  `owner` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '测试负责人',
  `testers` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '测试人员',
  `status` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '状态',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='项目测试表';

-- ----------------------------
-- Table structure for rdm_test_report
-- ----------------------------
DROP TABLE IF EXISTS `rdm_test_report`;
CREATE TABLE `rdm_test_report` (
  `test_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '测试ID',
  `covered` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '覆盖内容',
  `uncovered` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '未覆盖内容',
  `problems` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关键问题',
  `others` varchar(500) DEFAULT NULL COMMENT '其他说明',
  `checks` varchar(255) DEFAULT NULL COMMENT '校验和',
  `rounded` tinyint(4) DEFAULT NULL COMMENT '实际轮次',
  `result` char(1) DEFAULT NULL COMMENT '测试结果',
  PRIMARY KEY (`test_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='测试报告表';

-- ----------------------------
-- Table structure for rdm_test_suit
-- ----------------------------
DROP TABLE IF EXISTS `rdm_test_suit`;
CREATE TABLE `rdm_test_suit` (
  `suit_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '测试组件ID',
  `test_id` int(11) NOT NULL COMMENT '测试ID',
  `tests` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '测试组件',
  `systems` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统组件',
  `modified` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '修改内容',
  `affected` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '影响范围',
  `submited_time` datetime DEFAULT NULL COMMENT '提交时间',
  `completed_time` datetime DEFAULT NULL COMMENT '完成时间',
  PRIMARY KEY (`suit_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='测试组件表';
