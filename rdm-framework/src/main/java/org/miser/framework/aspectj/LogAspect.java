...
import org.miser.common.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(org.miser.common.annotation.Log)")
    ...
    public void getControllerMethodDescription(Log log, SysOperLog operLog) throws Exception {
        // 设置action动作
        operLog.setAction(log.businessAction().ordinal());
        // 设置标题
        operLog.setTitle(log.title());
        // 设置操作人类别
        operLog.setAccess(log.accessType().ordinal());
        // 是否需要保存request，参数和值
