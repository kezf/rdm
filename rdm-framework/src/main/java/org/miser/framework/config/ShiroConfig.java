...
import org.miser.framework.shiro.web.filter.LogoutFilter;
import org.miser.framework.shiro.web.filter.captcha.CaptchaValidateFilter;
import org.miser.framework.shiro.web.filter.online.OnlineSessionFilter;
import org.miser.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
...
public class ShiroConfig {
    ...
    public EhCacheManager getEhCacheManager() {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager(Global.getName());
